        ...
        <div class="divContainer">
                    ...
                    <div class="divMain">
                        <article class="articleContent">
                            ...
                            <section>
                                <p style="padding: 10px;">You have <?php echo getCountProducts(); ?> items in your cart. <br><a class="aContent" href="index.php">Continue to make purchases.</a></p>
                            ...
                            <section>
                                ...
                                <table class="tableRegister">
                                    <tr>
                                        <td><b>Name:</b> <span class="spanRequiredField">*</span></td>
                                        <td>
                                            <?php
                                            if ($user === '') {
                                                ?>
                                                ...
                                                echo $user['Name'];
                                                ?>
                                                <input name="txtName" type="hidden" size="30" value="<?php echo $user['Name']; ?>" />
                                                <?php
                                            }
                                            ?>
                                        </td>
                                    ...
                                    <tr>
                                        <td><b>Address:</b> <span class="spanRequiredField">*</span></td>
                                        <td>
                                            <?php
                                            if ($user === '') {
                                                ?>
                                                <textarea name="txtAddress" type="text" size="30" cols="30" rows="5" required=""></textarea>
                                                <?php
                                            } else {
                                                ?>
                                                <textarea name="txtAddress" type="text" size="30" cols="30" rows="5" value="" required=""><?php echo $user['Address']; ?></textarea>
                                                <?php
                                            }
                                            ?>
                                        </td>
                                    ...
                                    <tr>
                                        <td><b>Number:</b> <span class="spanRequiredField">*</span></td>
                                        <td>
                                            <?php
                                            if ($user === '') {
                                                ?>
                                                <input name="txtPhone" type="number" size="30" required=""/>
                                                <?php
                                            } else {
                                                ?>
                                                <input name="txtPhone" type="number" size="30" value="<?php echo $user['Phone']; ?>" required=""/>
                                                <?php
                                            }
                                            ?>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($user === '') {
                                                ?>
                                                <input name="txtEmail" type="email" size="30" />
                                                <?php
                                            } else {
                                                echo $user['Email'];
                                                ?>
                                                <input name="txtEmail" type="hidden" size="30" value="<?php echo $user['Email']; ?>" />
                                                <?php
                                            }
                                            ?>
                                        </td>
                                    ...
                                    <tr valign="top">
                                        <td><b>Request:</b> </td>
                                        <td>
                                            <textarea name="txtRequest" size="30" cols="30" rows="6" ></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
