        ...
        <div class="divContainer">
            ...
            <div class="divWrapper_2">
                    ...
                    <div class="divMain">
                        ...
                        <br><br>
                        <button type="button" style="padding: 10px 20px; background-color: red; color: white; border: none; border-radius: 5px; cursor: pointer;" onclick="window.location.href='index.php';">Back</button>
                    </div>
                </div>
            </div>
