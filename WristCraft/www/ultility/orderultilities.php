...
function getOrderStatus($con, $status) {
    switch ($status) {
        case 0:
            return "<span style='color: blueviolet; font-weight:bold'>Pending</span>";
        case 1:
            return "<span style='color: green; font-weight:bold'>Processing</span>";
        case 2:
            return "<span style='color: green; font-weight:bold'>Preparing Product/s</span>";
        case 3:
            return "<span style='color: green; font-weight:bold'>Shipping</span>";
        case 4:
            return "<span style='color: blue; font-weight:bold'>Received Product/s</span>";
        case 5:
            return "<span style='color: darkred; font-weight:bold'>Cancelled</span>";
    }
}
