            ...
            <div>
                    ...
                    <div class="divMain">
                            <div class="divWatchesPicture">
                                <img class="imgWatchesPicture" src="<?php echo $watches['Picture']; ?>"/>
                            </div>
                            ...
                            <div class="divWatchesRight">
                                ...
                                <div class="divAddCart">
                                    ...
                                    Amount: 
                                    <button type="button" onclick="decreaseQuantity()" style="padding: 15px; border: 1px solid #ccc; border-radius: 5px; font-size: 16px;">-</button>
                                    <input type="number" style="width: 50px; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 16px;" value="1" min="1" name="txtProductQuantity" id="inputQuantity"/> 
                                    <button type="button" onclick="increaseQuantity()" style="padding: 15px; border: 1px solid #ccc; border-radius: 5px; font-size: 16px;">+</button>
                                    <input type="submit" style="background-color: green; color: white; padding: 10px 20px; border: none; border-radius: 5px; font-size: 16px; cursor: pointer;" value="PURCHASE" name="btnButton" id="btnSubmitAddCart"/>
                                </div>
                                <script>
